...
//    }
    ...
    private function getListeDefaultCommandes()
    {
        return array( "veh_type"             => array('Type véhicule',       'info',  'string',     "", 0, 1, "GENERIC_INFO",   'core::badge', 'core::badge'),
                      ...
                      "charging_rate"        => array('Vitesse charge',      'info',  'numeric',"km/h", 1, 1, "GENERIC_INFO",   'core::line', 'core::line'),
                      "charging_mode"        => array('Mode charge',         'info',  'string',     "", 1, 1, "GENERIC_INFO",   'core::badge', 'core::badge'),
